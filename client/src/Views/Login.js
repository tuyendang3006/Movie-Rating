            ...
            <div style={{display:'flex', flexDirection:'row', height: "100vh", backgroundImage: 'linear-gradient(to bottom left, #77a6f7, black)'}}>
              <Carousel  interval={3000} style={{padding:0, margin:0}}>
                  <Carousel.Item>
                    ...
                    <img className="d-block h-100" src ='../../Assets/mulan-banner.jpg' alt = "First Slide"/>
                    </div>
                    <Carousel.Caption>
                  ...
                  <Carousel.Item>
                    <div className="carouselPic" style={{height:"90vh"}}>
                      <img className="d-block h-100" src ='../../Assets/parasite-banner.jpg' alt = "Second Slide"/>
                    </div>
                      <Carousel.Caption>
